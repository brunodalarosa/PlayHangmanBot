...
['Colors', 'Blue', 'Orange', 'Red', 'Yellow', 'Purple', 'Green', 'Silver', 'Gold', 'Pink', 'Turquoise', 'Cyan', 'Cerulean', 'Crimson', 'Bronze', 'Brown', 'Black', 'White', 'Aqua', 'Aquamarine', 'Tangerine', 'Magenta', 'Violet', 'Maroon', 'Lavender', 'Burgundy', 'Saffron', 'Indigo', 'Fuchshia']
    ]
