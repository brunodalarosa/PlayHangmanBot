...
'Black raspberry','Rambutan','Redcurrant','Salal berry','Satsuma','Star apple','Star fruit','Strawberry','Squash','Tamarillo','Tomato','Ugli fruit'],
['Countries', 'Afghanistan', 'Albania', 'Algeria', 'Andorra', 'Angola', 'Argentina', 'Armenia', 'Aruba', 'Australia', 'Austria', 'Azerbaijan', 'Bahrain',
'Bangladesh', 'Barbados', 'Belarus', 'Belgium', 'Belize', 'Benin', 'Bhutan', 'Bolivia', 'Bosnia and Herzegovina', 'Botswana', 'Brazil', 'Brunei', 'Bulgaria', 'Burundi', 'Burkina Faso', 'Burma', 'Burundi',
'Cambodia', 'Cameroon', 'Canada', 'Chad','Chile', 'China', 'Colombia', 'Republic of the Congo', 'Costa Rica', 'Croatia', 'Cuba', 'Cyprus','CzechRepublic',
...
'Iceland', 'India', 'Indonesia', 'Iran', 'Iraq', 'Ireland', 'Israel', 'Italy', 'Portugal', 'Paraguay','Philippines','New Zealand', 'Mexico', 'Madagascar', 'Peru', 'Russia', 'Serbia', 'Spain', 'Sudan', 'Sweden'],
['Professions', 'Accountant', 'Actor', 'Actuary', 'Archaeologist', 'Architect', 'Astronomer', 'Auditor','Author', 'Baker', 'Barber', 'Barista', 'Bookkeeper', 'Botanist', 'Bricklayer', 'Butcher', 'Cardiologist', 'Carpenter', 'Chemist', 'Chiropractor', 'Concierge', 'Cook', 'Cleaner', 'Dentist', 'Designer', 'Doctor', 'Electrician', 'Engineer', 'Farmer', 'Fireman', 'Fisherman', 'Florist', 'Gardener', 'Hairdresser', 'Journalist', 'Judge', 'Lawyer', 'Lecturer', 'Librarian', 'Lifeguard', 'Mechanic', 'Model', 'Newsreader', 'Nurse', 'Optician', 'Painter', 'Pharmacist', 'Photographer', 'Pilot', 'Plumber', 'Politician', 'Policeman',
 'Postman', 'Programmer', 'Receptionist', 'Scientist', 'Secretary', 'Shopassistant', 'Soldier', 'Tailor', 'Taxidriver', 'Teacher', 'Translator', 'Travelagent', 'Veterinary', 'Waiter', 'Zoologist'],
['Heroes and villains','batman','flash','wonder woman','penguin','super man','grenn lantern','grenn goblin','spider man','thor','hulk','iron man','ant man','human torch','the thing','black widow','green arrow','groot','rocket raccoon','magneto','wolverine','storm'],
['Videogame or game','the legend of zelda','super mario','counter strike','nintendo wii','super nintendo','playstation','steam','defense of the ancients','league of legends','final fantasy','donkey kong','angry birds','fallout','bioshock','tetris','the elder scrolls','minecraft','call of duty','battlefield','bomberman','sonic the hedgehog','just dance','nintendo','sony','sega','dreamcast'],
...
['Colors', 'Blue', 'Orange', 'Red', 'Yellow', 'Purple', 'Green', 'Silver', 'Gold', 'Pink', 'Turquoise', 'Cyan', 'Cerulean', 'Crimson', 'Bronze', 'Brown', 'Black', 'White', 'Aqua', 'Aquamarine', 'Tangerine', 'Magenta', 'Violet', 'Maroon', 'Lavender', 'Burgundy', 'Saffron', 'Indigo', 'Fuchshia', 'Amber', 'Apricot', 'Beige', 'Gunmetal', 'Ivory']
    ]
