...
acertou_letra_msg = 'Você acertou!'
errou_letra_msg = 'Errou'
jachutada_msg = 'Essa letra já foi chutada'
umavida_msg = 'Somente uma vida restante, reflita sobre a sua vida'
gameover_msg = 'PERDERAM LOSSERSS'
