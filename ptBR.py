...
palavras = [
                ...
                ['Heróis ou vilões','batman','flash','mulher maravilha','pinguim','super Homem','lanterna verde','duende verde','homem aranha','thor','hulk','homem de ferro','homem formiga','tocha humana','o coisa','viuva negra','arqueiro verde','groot','rocket raccoon','magneto','wolverine','tempestade','capita marvel', 'thanos','loki'],
				...
				['Objetos','Ventilador','Camisinha','Bolsa','Tesoura','Mapa','Vibrador','Caixa','Remedio','Camiseta','Bermuda','Desfibrilador','Cafeteira','Liquidificador','Vassoura','Porta','Cama'],
