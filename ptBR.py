...
palavras = [
	...
	['Objetos','Ventilador','Camisinha','Bolsa','Tesoura','Mapa','Vibrador','Caixa','remedio','Camiseta','Bermuda','Desfibrilador','Cafeteira','Liquidificador'
,'Vassoura', 'Vaso de Flor', 'Caneta', 'Lápis', 'Borracha','Apontador', 'Prato', 'Copo', 'Garfo', 'Régua'],
