...
palavras = [
                ...
                ['Comidas','Macarrão instantâneo','cachorro quente','lasanha','frango a passarinho','batata frita','ketchup','chocolate','strogonoff','Arroz e feijão','batata doce','pizza','sushi','temaki','fondue de chocolate','bolo','kitkat','pirulito','algodão doce','Escondidinho de carne seca','Torta de limão','Panqueca','Feijoada','Moqueca','Acarajé','Tapioca','Farofa','Torta de Frango','Bife Acebolado','Vegana','Vegetariana','Omelete','Bolinho de Arroz','Almôndegas','Doce de Leite','Salada de Maionese','Empadinha','Carne de Jaca','Catupiry','Requeijão','Esfiha de Carne','Sopa de Letrinhas','Biscoito de Polvilho','Costelinha de Porco'],
                ...
                ['Coisas de computador', 'programador','compilador','servidor','monitor','algoritmo','netflix','orkut','instagram','tumblr','twitter','rede neural','google','photoshop','wolfram alpha','python','java','framework','ruby','javascript','latex','android','stack overflow','wikipedia','debugging', 'swift', 'ios', 'kotlin'],
                ...
                ['Cidades do mundo','sarandi', 'brasília','curitiba','maringá','nova iorque','tokio','barcelona','amsterdã','paris','milão','pequim','berlim','são paulo','rio de janeiro','salvador','manaus','rio branco','orlando','los angeles','calgary','toronto','montreal','dallas','londres','cuiabá','macheral cândido rondon','campo mourão','toledo','Cascavel','Ouro preto',],
                ['Heróis ou vilões','Mestre Yoda','Anakin Skywalker','coringa','batman','flash','flash reverso','mulher maravilha','pinguim','super Homem','lanterna verde','duende verde','homem aranha','thor','hulk','homem de ferro','homem formiga','tocha humana','o coisa','viuva negra','arqueiro verde','groot','rocket raccoon','magneto','wolverine','tempestade', 'gamora'],
                ...
                ['Campeões de League of Legends' ,'Aatrox', 'Ahri', 'Akali', 'Alistar','Amumu','Anivia', 'Annie', 'Ashe', 'Azir', 'Bardo', 'Blitzcrank','Brand', 'Braum', 'Caitlyn', 'Cassiopeia','Cho Gath','Corki', 'Darius', 'Diana', 'Draven', 'Dr Mundo', 'Elise','Evelynn', 'Ezreal', 'Fiddlesticks', 'Fiora', 'Fizz', 'Galio', 'Gangplank', 'Garen', 'Gnar', 'Gragas', 'Graves', 'Hecarim','Heimerdinger', 'Illaoi', 'Irelia', 'Janna', 'Jarvan IV', 'Jax', 'Jayce', 'Jhin','Jinx', 'Kalista', 'Karma', 'Karthus', 'Kassadin', 'Katarina', 'Kayle', 'Kennen', 'Kha Zix','Kog Maw', 'LeBlanc', 'Lee Sin', 'Leona', 'Lissandra', 'Lucian', 'Lulu', 'Lux', 'Malphite','Malzahar',  'Maokai', 'Master Yi', 'Miss Fortune', 'Mordekaiser', 'Morgana', 'Nami', 'Nasus', 'Nautilus','Nidalee', 'Nocturne', 'Nunu', 'Olaf', 'Orianna', 'Pantheon', 'Poppy', 'Quinn', 'Rammus',  'Rek Sai','Renekton', 'Rengar', 'Riven',  'Rumble', 'Ryze', 'Sejuani', 'Shaco','Shen', 'Shyvana', 'Singed', 'Sion', 'Sivir', 'Skarner', 'Sona',  'Soraka', 'Swain', 'Syndra', 'Talon', 'Taric', 'Teemo', 'Thresh', 'Tristana', 'Trundle', 'Tryndamere', 'Twisted Fate', 'Tryndamere', 'Udyr', 'Urgot', 'Varus', 'Vayne', 'Veigar', 'Vel Koz', 'Vi','Viktor', 'Vladimir', 'Volibear', 'Warwick', 'Wukong', 'Xerath','Xin Zhao', 'Yasuo', 'Yorick', 'Zac', 'Zed', 'Ziggs', 'Zilean', 'Zyra'],
	        ['Objetos', 'Ventilador','Camisinha','Bolsa','Tesoura','Mapa','Vibrador','Caixa','remedio','Camiseta','Bermuda','Desfibrilador','Cafeteira','Liquidificador' ,'Vassoura', 'Vaso de Flor', 'Caneta', 'Lápis', 'Borracha','Apontador', 'Prato', 'Copo', 'Garfo', 'Régua'],
                ['Jogos de Super Nintendo', 'Top Gear', 'Street Fighter 2', 'Megaman X', 'Chrono Trigger', 'Star Fox', 'Super Metroid', 'Super Mario World', 'Donkey Kong Country', 'Secret of Mana', 'Final Fight', 'Sunset Riders', 'Harvest Moon', 'EarthBound', 'The Lion King', 'Aladdin', 'Breath of Fire'],
                ['Jogos de Celular', 'Hearthstone','Garena Free Fire','Pokémon Go','Minecraft','PUBG Mobile','Plants Vs Zombies','Clash of Clans','Oceanhorn','Knights of Pen & Paper','The Sims','Fallout Shelter','Asphalt','Mobile Legends','Arena of Valor','Clash Royale','Ragnarok','Marvel Future Fight','Candy Crush','Super Mario Run','Angry Birds','Grand Theft Auto: San Andreas','Last Day on Earth','Shadowmatic','Bubble Witch','Gangstar','Injustice','Mortal Kombat'],
	     	['Marcas de Celular', 'Samsung','Xiaomi','VIVO','Huawei','Motorola','LG','Sony','Apple','Asus','Nokia','Semp Toshiba','Venko','Multilaser','Blueberry','HTC','Elephone','Oppo','One Plus','Nubia','Umidigi','Redmi','Poco'],
            ]
categorias = ''
